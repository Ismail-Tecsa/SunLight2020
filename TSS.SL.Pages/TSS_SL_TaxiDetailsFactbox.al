page 50024 "Taxi Details FactBox"
{
    ...
    layout
    {
        area(content)
        {
            ...
            field(InspectionsDate; inspection1."Inspection Date")
            {
            ...
            field(MeterInspectionDate1; inspection1."Inspection Meter Date")
            {
                Caption = 'Inspection Meter Date';
                //Visible = false;
                ApplicationArea = all;
                trigger OnDrillDown()
                begin
    ...
    var
        Package: record "Service Contract Header";
        PackageLine: record "Service Contract Line";
        permit: Record permit;
        MeterInspectionDate: Date;
        MeterInspectionDate1: Date;
        InspectionsDate: Date;
        InspectionsDate1: Date;
    ...
    local procedure ShowInsuranceDetails()
    begin
        PAGE.Run(PAGE::"Insurance Card", insurance);
    end;

    local procedure ShowCarInspectionDetails()
    begin
        PAGE.Run(PAGE::"Inspection Card", inspection1);

    end;

    local procedure ShowMeterInspectionDetails()
    begin
        PAGE.Run(PAGE::"Inspection Card", inspection2);

    end;

    local procedure ShowPermitDetails()
    begin
