  ...
  layout
  {
      ...
      group(General)
      {
        field("Settlement ID";Rec."Settlement ID")
        {
          ...
          trigger OnValidate()begin
            currpage."Settlement Lines".Page.SetDoc("Settlement ID");
          end;
        }
    ...
    area(factboxes)
    {
      ...
      part("Attached Documents";"Document Attachment Factbox")
      {
        ...
        //  Visible = ("Taxi ID" <> '');
        Caption = 'Attachments';
        SubPageLink = "Table ID"=CONST(50022), "No."=FIELD("Settlement ID");
      }
  ...
  actions
  {
    area(Processing)
    {
      ...
      action("Approve")
      {
        ...
        trigger OnAction()var UserSetup: record "User Setup";
        begin
          TestField(Status, status::"Pending Approval");
          ...
          if UserSetup."management Approver" then begin
            ...
            if Status = Status::"Pending Approval" then Status:=Status::"Pending Payment";
      ...
      action("Close Settlement")
      {
        ...
        trigger OnAction()var SetLines: record "Settlement Lines";
      ...
      action("Cancel Settlement")
      {
        ...
        trigger OnAction()begin
          if "PG10 No." <> '' then error('You cannot cancel a settlement that already has a PG10');
