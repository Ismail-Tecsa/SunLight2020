page 50025 "Driver Details FactBox"
{
    ...
    begin
        ...
        if "Driving License Expiry" > today then
            LicStatus := LicStatus::Active;
        if "PSV License Expiry" > today then
            PSVStatus := PSVStatus::Active;
    end;
    ...
    begin
        if "Date of Birth" <> 0D then begin
            ...
            if Date2DMY(today, 2) < Date2DMY("date of birth", 2) then
                age -= 1;
        end;
    ...
    begin
        if contracthead.get(contracthead."Contract Type"::Contract, contract) then
