page 50021 "Sunlight Attachments Factbox"
{
                        ...
                        case "Table ID" of
                            ...
                            DATABASE::Taxis:
                                begin
                                    ...
                                    if taxi.Get("No.") then
                                        RecRef.GetTable(Taxi);
                                end;
                            DATABASE::Permit:
                                begin
                                    RecRef.Open(DATABASE::Permit);
                                    if permit.Get("No.") then
                                        RecRef.GetTable(permit);
                                end;
    ...
    local procedure OnBeforeDrillDownSunlight(DocumentAttachment: Record "Document Attachment"; var RecRef: RecordRef)
    begin
    end;
