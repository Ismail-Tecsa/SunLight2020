  ...
  fields
  {
    ...
    field(12;"Permit Locked";Boolean)
    {
      ...
      begin
        ...
        if Permit.locked then error('This Permit is locked for changes, please unlock the permit to assign it to a new Taxi');
        Permit.LockPermit();
      end;
    }
    ...
    field(21;"Permit ID";code[20])
    {
      ...
      trigger OnValidate()var TIPEntry: Record "TIP Entry";
    ...
    field(64;"Grant VR1";Boolean)
    {
      ...
      trigger OnValidate()begin
        if "Grant VR1" then "Grant VR1 Received Date":=workdate;
      end;
    }
