table 50022 "CM Accident"
{
    ...
    fields
    {
        ...
        //TSA_ISMAIL Modified Accident Venue to Accident Person and text to Option
        field(5; "Accident Venue"; Text[100])
        {
            Caption = 'Accident Venue';
            DataClassification = ToBeClassified;
            //OptionMembers = "Driver1","Driver2";
        }
        //TSA_ISMAIL Modified Accident Venue to Accident Person and text to Option
        field(6; "Police Report Obtained"; Boolean)
        {
            ...
            trigger OnValidate()
            begin
                if "Police Report Obtained" then
                    "Police Report Obtained Date" := today;
            end;
        }
        ...
        field(12; LTA; Text[30]) //TSA_ISAMIL Changed LTA to LTA No and Text to code
        {
            Caption = 'LTA';
            DataClassification = ToBeClassified;
        }
        field(13; "LTA Amount"; Decimal) // TSA_ISMAI Changed LTA Amount to LTA Installment Amount
        {
            Caption = 'LTA Amount';
            DataClassification = ToBeClassified;
        }
        ...
        field(21; "Investigation Result"; Option)
        {
            Caption = 'Investigation Result';
            OptionMembers = "Fail","Sucessful";
            DataClassification = ToBeClassified;
        }
        ...
        field(42; "Document Handover"; Boolean)
        {
            ...
            begin
                if "Document Handover" then
                    "Doc. Handover Date" := today;
            end;
        ...
        //TSA_ISMAIL added Insurance No.
        field(90; "Insurance No."; Code[20])
        {
            DataClassification = ToBeClassified;
            Caption = 'Insurance No.';
        }
        field(91; "Damage Type"; Option)
        {
            Caption = 'Damage Type';
            OptionMembers = "Vehicle","Body Injury";
            DataClassification = ToBeClassified;
        }
        field(92; "Date Settled"; Date)
        {
            Caption = 'Date Settled';
            DataClassification = ToBeClassified;
        }
        field(93; "Accident Person"; Option)
        {
            Caption = 'Accident Person';
            DataClassification = ToBeClassified;
            OptionMembers = "Driver1","Driver2";
        }
        field(94; "LTA No."; Code[30])
        {
            Caption = 'LTA No.';
            DataClassification = ToBeClassified;
        }
        field(95; "LTA Installment Amount"; Decimal) // TSA_ISMAI Changed LTA Amount to LTA Installment Amount
        {
            Caption = 'LTA Installment Amount';
            DataClassification = ToBeClassified;
        }
        //TSA_ISMAIL added Insurance No.
    }
