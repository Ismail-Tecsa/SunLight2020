table 50030 "CM PG10"
{
    ...
    fields
    {
        ...
        field(2; "Settlement ID"; Code[10])
        {
            ...
            begin
                ...
                if taxi."Active Contract" <> '' then begin
                    ...
                    if settlement."Settlement Paid" <> settlement."Settlement Amount" then
                        error('The Settlement must be fully paid before PG10 can be started.')
                end;
        ...
        field(3; "Workshop Dismantle"; Boolean)
        {
            ...
            begin
                if "Workshop Dismantle" then
                    "Workshop Dismantle Date" := today;
            end;
        }
        ...
        field(5; "Permit Cancellation"; Boolean)
        {
            ...
            begin
                if "Permit Cancellation" then
                    "Permit Cancellation Date" := today;
            end;
        }
        ...
        field(7; "B2 Inspection"; Boolean)
        {
            ...
            begin
                if "B2 Inspection" then
                    "B2 Inspection Date" := today;
            end;
        }
        ...
        field(11; "Company Document"; Boolean)
        {
            ...
            begin
                if "company document" then
                    "Company document Date" := today;
            end;
        ...
        field(13; "B5 Inspection"; Boolean)
        {
            ...
            begin
                if "B5 Inspection" then
                    "b5 inspection Date" := today;
            end;
        ...
        field(15; "JPJ Transfer Ownership"; Boolean)
        {
            ...
            begin
                if "JPJ Transfer Ownership" then
                    "JPJ Transfer Ownership Date" := today;
            end;
        ...
        field(33; "Cancel PG10"; Boolean)
        {
            ...
            begin
                ...
                if "JPJ Transfer Ownership" then
                    error('Cannot cancel as JPJ process already started.');
