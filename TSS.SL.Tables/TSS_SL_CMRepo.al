        ...
        field(2; "Repo Status"; Option)
        {
            ...
            begin
                if "repo status" <> xRec."repo status" then begin
                    if ("Repo Status" = "Repo Status"::Cancelled) or
                        ("Repo Status" = "Repo Status"::Confirmed) then begin
                    ...
                    if ("Repo Status" = "Repo Status"::Pending) or
                       ("Repo Status" = "Repo Status"::Untraced) then begin
                        casehead.get("Case ID");
                        if ContHead.get(conthead."Contract Type"::Contract, CaseHead."Contract No.") then begin
