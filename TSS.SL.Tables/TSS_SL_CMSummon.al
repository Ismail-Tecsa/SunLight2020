table 50021 "CM Summon"
{
    ...
    fields
    {
        ...
        field(6; "Inform Driver"; Boolean)
        {
            ...
            begin
                if "Inform Driver" then
                    "Inform Driver Date" := today;
            end;
        }
        ...
        field(8; "Driver Collect"; Boolean)
        {
            ...
            begin
                if "Driver Collect" then
                    "driver collect Date" := today;
            end;
        ...
        field(16; "1st Follow Up"; Boolean)
        {
            ...
            begin
                if "1st Follow Up" then
                    "1st Follow Up Date" := today;
            end;
        ...
        field(18; "2nd Follow Up"; Boolean)
        {
            ...
            begin
                if "2nd Follow Up" then
                    "2nd Follow Up Date" := today;
            end;
        }
        ...
        field(20; "3rd Follow Up"; Boolean)
        {
            ...
            begin
                if "3rd Follow Up" then
                    "3rd Follow Up Date" := today;
            end;
        ...
        field(22; "Attendance Letter"; Boolean)
        {
            ...
            begin
                if "Attendance Letter" then
                    "Attendance Letter Date" := today;
            end;
        ...
        field(24; "Result Received"; Boolean)
        {
            ...
            begin
                if "Result Received" then
                    "Result Received Date" := today;
            end;
        ...
        field(28; "Summon Transferred"; Boolean)
        {
            ...
            begin
                if "Summon Transferred" then
                    "Date of Transfer" := today;
            end;
        ...
        field(39; "Invoice Generated"; Boolean)
        {
            ...
            begin
                if "Invoice Generated" then
                    "Invoice Generated Date" := today;
            end;
        ...
        field(47; "Claim Generated"; Boolean)
        {
            ...
            begin
                if "Claim Generated" then
                    "Claim Generated Date" := today;
            end;
        ...
        field(53; "Pay Receipt Obtained"; Boolean)
        {
            ...
            begin
                if "Pay Receipt Obtained" then
                    "Pay Receipt Date" := today;
            end;
