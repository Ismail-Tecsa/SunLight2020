        ...
        field(4; "Taxi ID"; Code[10])
        {
            ...
            begin
                ...
                if taxis.get("Taxi ID") then begin
                    if taxis."Permit ID" <> '' then
                        validate("Permit ID", taxis."Permit ID");
            ...
            begin
                if ContractHead.get(ContractHead."Contract Type"::Contract, "Contract No.") then begin
                    ...
                    if CurrFieldNo = FieldNo("Contract No.") then begin
                        if "Taxi ID" = '' then
                            validate("Taxi ID", ContractLine."Taxi ID");
                ...
                case xRec.type of
                        ...
                        begin
                            if CMAccident.get("Case ID") then
                                if Confirm('Are you sure you want to delete the existing type details?') then begin
                                    ...
                                    if CMAccOffer.findset() then
                                        cmaccoffer.Deleteall();
                                end;
                        end;
                    xrec.type::PG10:
                        begin
                    ...
                    xrec.type::Repo:
                        begin
                            ...
                            if CMRepoSpoil.FindSet() then
                                CMRepoSpoil.deleteall;
                        end;
                end;
