table 50024 "Case Cue"
{
    ...
    fields
    {
        ...
        field(2; "Pending Cases"; Integer)
        {
            ...
            Editable = false;
            CalcFormula = count("Case" where(Status = const(Pending),
                                             "Case Company" = field("Primary Key")));
        }
        ...
        field(8; "Closed Cases"; Integer)
        {
            ...
            FieldClass = FlowField;
            Editable = false;
            CalcFormula = count("Case" where(Status = const(Closed),
                                            "Case Settled" = const(true),
                                             "Case Company" = field("Primary Key")));
